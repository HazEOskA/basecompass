...
export const roadmap: RoadmapDay[] = [
  ...
  },
  {
    ...
    goal: 'Take your first step into building on Base — whether that\'s writing Solidity, using no-code tools, or creating Frames.',
    tasks: [
      'Start Base Camp Module 1 — even 30 minutes gives you the foundations.',
      'Open Remix IDE and deploy the default Storage.sol to Base Sepolia testnet.',
      'Clone the OnchainKit quickstart template and run it locally.',
      'Browse active Builder Grants to understand what projects get funded.',
    ...
    tools: ['Base Camp', 'Remix IDE', 'OnchainKit'],
  ...
  },
  {
    ...
    tasks: [
      'Complete the Odyssey / Onchain Summer missions to earn Base attestations.',
      'Review the Base Builder Grants page and assess if your project qualifies.',
    ...
    tools: ['Odyssey', 'Base Builder Grants', 'Farcaster'],
